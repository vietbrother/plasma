...
export default class TakePhoto extends Component {
    ...
    cleanData(data) {
        ...
        var arr = JSON.parse(data._bodyInit);
        var textDetect = '';
        ...
        Actions.home({textDetect: textDetect, capturePhotoPath: this.props.pictureData.uri});
        //
    ...
    async usePhoto(imgPath) {
        ...
        try {
            ...
            NativeModules.RNImageToBase64.getBase64String(this.props.captureData.uri, async (err, base64) => {
                ...
                <ImageBackground
                    ...
                    <View style={styles.bottomBar}>
                        <Grid>
                            ...
                            <Col>
                                <TouchableOpacity onPress={this.convertImg.bind(this)}>
